...
public class DraftOrderCreateMutation: GraphQLMutation {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation draftOrderCreate($input: DraftOrderInput!) { draftOrderCreate(input: $input) { __typename draftOrder { __typename id name email subtotalPrice note2 totalPrice lineItems(first: 100) { __typename nodes { __typename quantity variant { __typename id price availableForSale title } product { __typename id priceRangeV2 { __typename maxVariantPrice { __typename amount currencyCode } } title productType featuredImage { __typename url } } } } } } }"#
    ))
