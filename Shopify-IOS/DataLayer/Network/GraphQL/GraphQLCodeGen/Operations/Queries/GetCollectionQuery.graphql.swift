...
extension GraphQLCodeGen {
  class GetCollectionQuery: GraphQLQuery {
    ...
    struct Data: GraphQLCodeGen.SelectionSet {
      ...
      struct Collection: GraphQLCodeGen.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
        ...
        struct Products: GraphQLCodeGen.SelectionSet {
          ...
          struct Node: GraphQLCodeGen.SelectionSet {
            ...
            /// Collection.Products.Node.Category
            ///
            ...
            /// Collection.Products.Node.VariantsCount
            ///
            /// Parent Type: `Count`
            ...
            /// Collection.Products.Node.Variants
            ///
            ...
            struct Variants: GraphQLCodeGen.SelectionSet {
              ...
              /// Collection.Products.Node.Variants.Node
              ///
              ...
              struct Node: GraphQLCodeGen.SelectionSet {
                ...
                /// Collection.Products.Node.Variants.Node.Image
                ///
                /// Parent Type: `Image`
                ...
                /// Collection.Products.Node.Variants.Node.Price
                ///
                /// Parent Type: `MoneyV2`
                ...
                /// Collection.Products.Node.Variants.Node.UnitPrice
                ///
                /// Parent Type: `MoneyV2`
                ...
                /// Collection.Products.Node.Variants.Node.SelectedOption
                ///
                ...
                /// Collection.Products.Node.Variants.Node.QuantityRule
                ///
                ...
                /// Collection.Products.Node.Variants.Node.Product
                ///
                /// Parent Type: `Product`
                struct Product: GraphQLCodeGen.SelectionSet {
                  ...
                  /// Collection.Products.Node.Variants.Node.Product.FeaturedImage
                  ///
                  /// Parent Type: `Image`
                  struct FeaturedImage: GraphQLCodeGen.SelectionSet {
                    let __data: DataDict
